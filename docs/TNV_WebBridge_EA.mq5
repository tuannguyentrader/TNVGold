...
//| v2.00 - GlobalVariable version (đọc TNV_SIGNAL_BIAS)             |
...
void SendPulseToWeb()
{
   ...
   if(GlobalVariableCheck("TNV_SIGNAL_BIAS")) {
      ...
      if(sig == 1)      { bias = "LONG";   score = 8; }
      else if(sig == 2) { bias = "SHORT";  score = 8; }
   ...
   string json = StringFormat(
      ...
      _Symbol, TimeToString(TimeCurrent(), TIME_SECONDS), price, bias, score,
